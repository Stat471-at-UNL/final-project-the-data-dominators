...
![](images/clipboard-2362076978.png)
...
variables and the cognitive variables for both years. In all cases, the
MCAR test was highly significant (p \< 0.001), indicating strong
evidence against MCAR. This suggests that missingness is related to
observed or unobserved characteristics, and it supports the use of
