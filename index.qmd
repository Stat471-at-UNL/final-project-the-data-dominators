...
For the Cognitive Decline topic, we observe only 2 different variables
...
For the Tobacco Use topic, we observe 4 different variables
pertaining to tobacco use. There are 14,528 rows of data
containing observations.
...
-   `MARITAL`, `EDUCA`, `VETERAN3`, `EMPLOY1`, `CHILDREN`, `INCOME3`, `PREGNANT`, `WEIGHT2`, `CRACE1`, `ASTHMS1`, `CAGEG`, `AGE80`, `CHCOCNC1`, `ALCDAY4`, `MARJSMOK`, `GENHLTH`, `MENTHLTH`
...
After splitting up the dataset, we verified that `SEQNO` is unique within each year's BRFSS Missouri subset, and can use it as the primary key
